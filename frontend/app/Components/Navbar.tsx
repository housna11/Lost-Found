      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center gap-8 text-base">
            ...
            <Link href="objets" className="hover:opacity-80 transition font-medium">
              Mes objets
            </Link>
            {role === "admin" && (
            <Link href="/dashboard" className="hover:opacity-80 transition font-medium">
              Dashboard
            </Link>
          )}
            {!isAuthenticated ? (
            ...
            <button
              ...
              className="text-white px-5 py-2 rounded-lg border border-white/30 hover:bg-white hover:text-[#0474C4] transition font-medium text-base cursor-pointer">
              Déconnexion
            </button>
          )}
          </div>
